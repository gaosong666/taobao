...
SECRET_KEY = 'c!-#wqp_dxgjdpjsk!v)*=(q4lp$#m(hxgir*@_(6ph!63cxo3'
...
QQ_REDIRECT_URI = 'http://www.meiduo.site:8080/sina_callback.html'
...
# FastDFS
FDFS_URL = 'http://192.168.239.132:8888/'  # 访问图片的路径域名 ip地址修改为自己机器的ip地址
...
CRONJOBS = [
    ...
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/Desktop/note/meiduo34/mall/logs/crontab.log')
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.239.132:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
